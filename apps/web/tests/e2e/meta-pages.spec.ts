...
test('generated guides expose the canonical public content without revealing hidden badges', async ({ page }) => {
  ...
  await expect(badge('Bridge Read')).toContainText('3,200 (+25 XP) · 4,000 (+50 XP)')
  await expect(badge('Big Spender')).toContainText('2,000 (+25 XP) · 3,000 (+50 XP)')
  await expect(badge('Trade Reader')).toContainText('80 (+25 XP) · 100 (+50 XP)')
  ...
  await expect(badge('Herald')).toContainText('8 (+25 XP) · 10 (+50 XP)')
  await expect(badge('Recruiter')).toContainText('1 (+5 XP) · 2 (+10 XP) · 3 (+10 XP) · 4 (+25 XP) · 5 (+50 XP)')
