...
const RANKS: StarRank[] = [
  ...
  { n: 2, name: 'Bone Pit', slug: 'bone-pit', threshold: 50, image: '/assets/arenas/02-bone-pit.png' },
  {
    n: 3,
    name: 'Barbarian Bowl',
    slug: 'barbarian-bowl',
  ...
  { n: 4, name: 'Spell Valley', slug: 'spell-valley', threshold: 100, image: '/assets/arenas/04-spell-valley.png' },
  {
    n: 5,
  ...
  { n: 7, name: 'Royal Arena', slug: 'royal-arena', threshold: 220, image: '/assets/arenas/07-royal-arena.png' },
  { n: 8, name: 'Frozen Peak', slug: 'frozen-peak', threshold: 280, image: '/assets/arenas/08-frozen-peak.png' },
  { n: 9, name: 'Jungle Arena', slug: 'jungle-arena', threshold: 350, image: '/assets/arenas/09-jungle-arena.png' },
  { n: 10, name: 'Hog Mountain', slug: 'hog-mountain', threshold: 450, image: '/assets/arenas/10-hog-mountain.png' },
  {
    n: 11,
    name: 'Electro Valley',
    slug: 'electro-valley',
  ...
  { n: 12, name: 'Spooky Town', slug: 'spooky-town', threshold: 700, image: '/assets/arenas/12-spooky-town.png' },
  {
    n: 13,
  ...
  { n: 15, name: "Miner's Mine", slug: 'miners-mine', threshold: 1300, image: '/assets/arenas/15-miners-mine.png' },
  {
    n: 16,
  ...
  { n: 17, name: 'Royal Crypt', slug: 'royal-crypt', threshold: 2000, image: '/assets/arenas/17-royal-crypt.png' },
  {
    n: 18,
  ...
  { n: 19, name: 'Dragon Spa', slug: 'dragon-spa', threshold: 3000, image: '/assets/arenas/19-dragon-spa.png' },
  { n: 20, name: 'Boot Camp', slug: 'boot-camp', threshold: 3650, image: '/assets/arenas/20-boot-camp.png' },
  { n: 21, name: 'Clash Fest', slug: 'clash-fest', threshold: 4450, image: '/assets/arenas/21-clash-fest.png' },
  { n: 22, name: 'PANCAKES!', slug: 'pancakes', threshold: 5400, image: '/assets/arenas/22-pancakes.png' },
  { n: 23, name: 'Valkalla', slug: 'valkalla', threshold: 6600, image: '/assets/arenas/23-valkalla.png' },
  {
    n: 24,
  ...
  { n: 26, name: 'Royal Road', slug: 'royal-road', threshold: 11800, image: '/assets/arenas/26-royal-road.png' },
  {
    n: 27,
