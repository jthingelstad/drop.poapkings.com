...
const LABELS: Record<ReviewStatus, { word: string; accessible: string }> = {
...
export default function ReviewStatusMark({
  ...
  // The awaiting ring is a stamp that has not landed yet: never rotate it.
  const rotation = status === 'pending' ? 0 : ROTATIONS[index % ROTATIONS.length]
  return (
