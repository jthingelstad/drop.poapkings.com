...
//   · Never over the column or the aside; both keep an opaque backdrop.
//   · Off under reduced motion, off during a game (already full-bleed), and off
//     on the ranked gate: nothing ambient behind a screen asking for a decision.
//
...
const SLOTS: Array<{ left: number; top: number; width: number; rotate: number; opacity: number }> = [
  { left: 4.1, top: 68.0, width: 61, rotate: 9.7, opacity: 0.11 },
  { left: 15.6, top: 81.5, width: 68, rotate: -19.6, opacity: 0.12 },
  { left: 51.4, top: 39.4, width: 95, rotate: -6.9, opacity: 0.11 },
  { left: 74.9, top: 30.9, width: 50, rotate: 7.3, opacity: 0.13 },
  { left: 23.3, top: 8.3, width: 63, rotate: 0.4, opacity: 0.09 },
  { left: 19.3, top: 30.9, width: 50, rotate: 16.3, opacity: 0.06 },
  { left: 48.2, top: 77.0, width: 54, rotate: -19.6, opacity: 0.08 },
  { left: 3.1, top: 20.9, width: 94, rotate: -17.6, opacity: 0.09 },
  { left: 95.2, top: 77.8, width: 96, rotate: 17.5, opacity: 0.1 },
  { left: 32.4, top: 14.5, width: 80, rotate: 20.6, opacity: 0.06 },
  { left: 63.1, top: 27.8, width: 58, rotate: 18.1, opacity: 0.12 },
  { left: 87.6, top: 88.3, width: 76, rotate: 0.2, opacity: 0.15 },
  { left: 35.8, top: 51.8, width: 77, rotate: -0.4, opacity: 0.08 },
  { left: 11.8, top: 37.2, width: 66, rotate: -20.9, opacity: 0.09 },
  { left: 4.7, top: 70.8, width: 48, rotate: 12.1, opacity: 0.11 },
  { left: 66.8, top: 97.2, width: 50, rotate: 9.1, opacity: 0.06 },
  { left: 57.5, top: 57.5, width: 70, rotate: 1.1, opacity: 0.12 },
  { left: 55.0, top: 33.6, width: 72, rotate: 12.9, opacity: 0.09 }
]
      ...
      {SLOTS.map((slot, index) => (
        <img
          ...
          style={{
            ...
            // Every card drifts on the same slow loop, offset so the field never
            // pulses in unison.
