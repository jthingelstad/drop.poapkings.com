      ...
      PolicyDocument: JSON.stringify({
        ...
        Statement: [
          ...
          },
          {
            ...
            Resource: [
              `arn:aws:logs:${region}:${accountId}:delivery:*`,
              `arn:aws:logs:${region}:${accountId}:delivery-destination:elixir-drop-*`,
              `arn:aws:logs:${region}:${accountId}:delivery-source:elixir-drop-*`,
            ],
          },
          {
            Effect: "Allow",
