...
const PRESERVED_PARAMETERS = [
  ...
  // Operational alarms are deliberately independent of the player-mail
  // sender. Changing elixir@ (magic links) must never retarget alarms away
  // from the monitored drop@ mailbox.
